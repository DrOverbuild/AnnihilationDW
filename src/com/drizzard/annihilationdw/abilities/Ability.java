...
public class Ability implements Listener {
    ...
    /**
     * Called whenever the ability is added to a player. This happens when the player's kit is being
     * set up. Override
    ...
    /**
     * Called whenever the ability is removed from a player. This happens when the player changes
     * kits, leaves the
     * server, or when the game ends. Override this to clear any lists or cancel any running
     * timers.
     */
