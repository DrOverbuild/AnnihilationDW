 ...
 *         for an implementation that avoids the problems of getTotalExperience(), which doesn't
 *         work properly after a player has enchanted something.
 *
...
public class ExperienceManager {
     ...
     *
     * @throws IllegalArgumentException if the level is less than 0 or greater than the current
     *                                  hard
     *                                  maximum
     */
