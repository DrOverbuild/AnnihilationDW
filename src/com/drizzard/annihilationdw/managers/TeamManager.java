...
public class TeamManager {
    ...
    /**
     * Returns a list of all the teams whose nexus health is greater than zero and has players that
     * are currently
     * online. If a team has players, but none of them are currently online, then that team is not
     * included in the
     * returned list.
     */
